...
const NOTION_API_KEY = "secret_xxxxxxx";

//Discordサーバーのユーザー情報読み取り権限を有するBOT-TOKEN
const DISCORD_BOT_KEY = "xxx.xxxxxxxxx";
...
const roles = {
  ...
  "917331539212255273": "Dev",
  "923625522485932112": "AMA",
  "923625906696769556": "Community",
  "923626125672976424": "Design",
  "923663531176493106": "Wagumi Cats",
  "924463951524290560": "AMA Leader",
  "924464553683738665": "Newsletter Leader",
  "924464796995305482": "Design Leader",
  "924464899562827797": "Community Leader",
  "924465026960621588": "Dev Leader",
  "924473090325504031": "Newsletter",
  "928751291629453322": "Growth",
  "928751373644865597": "Growth Leader",
  "928751655388844074": "Governance",
  "928751686049230898": "Governance Leader",
  "948119284637384744": "Investor",
  "959523339037208646": "advisor",
  "998079254447276083": "WG Token",
  "1017617843916902411": "Wagumi SBT",
  "1031628123457978389": "WG SBT",
};
...
async function updateMember(member) {
  ...
  if (member.icon) {
    icon.push({
      name: member.icon.length <= 100 ? member.icon : "https://discord.com/assets/2d20a45d79110dc5bf947137e9d99b66.svg",
      type: "external",
      external: { url: member.icon.length <= 100 ? member.icon : "https://discord.com/assets/2d20a45d79110dc5bf947137e9d99b66.svg" },
    });
  }
  try {
...
async function createDiscordMembersJson(nextid = null) {
  let endpoint = "https://discord.com/api/v10/guilds/914960638365810748/members?limit=1000";
  if (nextid) {
  ...
  const response = await fetch(endpoint, {
    headers: {
      accept: "*/*",
      "User-Agent": "DiscordBot (http://www.ukishima.xyz/dev/discord/,1.0.0)",
  ...
  for (let i = 0; i < result.length; i++) {
    ...
    if (data.avatar) {
      ...
      member.icon = "https://discord.com/assets/f9bb9c4af2b9c32a2c5ee0014661546d.png";
    }
